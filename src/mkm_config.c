...
{
	{ "cardmarket_id", MKM_CONFIG_COLUMN_TYPE_CSV, MKM_CONFIG_COLUMN_DATA_TYPE_UINT32, 0, MKM_FALSE, MKM_CSV_COLUMN_ID_PRODUCT									},
	{ "price", MKM_CONFIG_COLUMN_TYPE_CSV, MKM_CONFIG_COLUMN_DATA_TYPE_PRICE, 0, MKM_FALSE, MKM_CSV_COLUMN_PRICE												},
	{ "csv_language", MKM_CONFIG_COLUMN_TYPE_CSV, MKM_CONFIG_COLUMN_DATA_TYPE_UINT32, 0, MKM_FALSE, MKM_CSV_COLUMN_ID_LANGUAGE									},
	{ "condition", MKM_CONFIG_COLUMN_TYPE_CSV, MKM_CONFIG_COLUMN_DATA_TYPE_UINT32, 0, MKM_FALSE, MKM_CSV_COLUMN_CONDITION										},
	...
	{ "shipping_cost", MKM_CONFIG_COLUMN_TYPE_SHIPMENT_SHIPPING_COST, MKM_CONFIG_COLUMN_DATA_TYPE_PRICE, 0, MKM_FALSE, 0										},
	{ "purchase_date", MKM_CONFIG_COLUMN_TYPE_SHIPMENT_PURCHASE_DATE, MKM_CONFIG_COLUMN_DATA_TYPE_PRICE, 0, MKM_FALSE, 0										},
	{ "trustee_fee", MKM_CONFIG_COLUMN_TYPE_SHIPMENT_TRUSTEE_FEE, MKM_CONFIG_COLUMN_DATA_TYPE_PRICE, 0, MKM_FALSE, 0											},
	{ "unique_id", MKM_CONFIG_COLUMN_TYPE_SHIPMENT_UNIQUE_ID, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, 0, MKM_FALSE, 0												},
	{ "tcgplayer_id", MKM_CONFIG_COLUMN_TYPE_SFC_TCGPLAYER_ID, MKM_CONFIG_COLUMN_DATA_TYPE_UINT32, 0, MKM_FALSE, 0												},
	{ "collector_number", MKM_CONFIG_COLUMN_TYPE_SFC_COLLECTOR_NUMBER, MKM_CONFIG_COLUMN_DATA_TYPE_UINT32, 0, MKM_FALSE, 0										},
	{ "color_is_red", MKM_CONFIG_COLUMN_TYPE_SFC_COLOR_IS_RED, MKM_CONFIG_COLUMN_DATA_TYPE_BOOL, 0, MKM_FALSE, 0												},
	{ "color_is_blue", MKM_CONFIG_COLUMN_TYPE_SFC_COLOR_IS_BLUE, MKM_CONFIG_COLUMN_DATA_TYPE_BOOL, 0, MKM_FALSE, 0												},
	{ "color_is_green", MKM_CONFIG_COLUMN_TYPE_SFC_COLOR_IS_GREEN, MKM_CONFIG_COLUMN_DATA_TYPE_BOOL, 0, MKM_FALSE, 0											},
	{ "color_is_black", MKM_CONFIG_COLUMN_TYPE_SFC_COLOR_IS_BLACK, MKM_CONFIG_COLUMN_DATA_TYPE_BOOL, 0, MKM_FALSE, 0											},
	{ "color_is_white", MKM_CONFIG_COLUMN_TYPE_SFC_COLOR_IS_WHITE, MKM_CONFIG_COLUMN_DATA_TYPE_BOOL, 0, MKM_FALSE, 0											},
	{ "color_identity_is_red", MKM_CONFIG_COLUMN_TYPE_SFC_COLOR_IDENTITY_IS_RED, MKM_CONFIG_COLUMN_DATA_TYPE_BOOL, 0, MKM_FALSE, 0								},
	{ "color_identity_is_blue", MKM_CONFIG_COLUMN_TYPE_SFC_COLOR_IDENTITY_IS_BLUE, MKM_CONFIG_COLUMN_DATA_TYPE_BOOL, 0, MKM_FALSE, 0							},
	{ "color_identity_is_green", MKM_CONFIG_COLUMN_TYPE_SFC_COLOR_IDENTITY_IS_GREEN, MKM_CONFIG_COLUMN_DATA_TYPE_BOOL, 0, MKM_FALSE, 0							},
	{ "color_identity_is_black", MKM_CONFIG_COLUMN_TYPE_SFC_COLOR_IDENTITY_IS_BLACK, MKM_CONFIG_COLUMN_DATA_TYPE_BOOL, 0, MKM_FALSE, 0							},
	{ "color_identity_is_white", MKM_CONFIG_COLUMN_TYPE_SFC_COLOR_IDENTITY_IS_WHITE, MKM_CONFIG_COLUMN_DATA_TYPE_BOOL, 0, MKM_FALSE, 0							},
	{ "name", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, 0, MKM_FALSE, 0															},
	{ "set", MKM_CONFIG_COLUMN_TYPE_SFC_SET, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, 0, MKM_FALSE, 0																},
	{ "version", MKM_CONFIG_COLUMN_TYPE_SFC_VERSION, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, 0, MKM_FALSE, 0														},
	{ "released_at", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_RELEASED_AT, MKM_FALSE, 0							},
	{ "rarity", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_RARITY, MKM_FALSE, 0										},
	{ "language", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_LANGUAGE, MKM_FALSE, 0									},
	{ "scryfall_id", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_SCRYFALL_ID, MKM_FALSE, 0							},
	{ "layout", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_LAYOUT, MKM_FALSE, 0										},
	{ "mana_cost", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_MANA_COST, MKM_FALSE, 0								},
	{ "string_cmc", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_CMC, MKM_FALSE, 0									},
	{ "type_line", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_TYPE_LINE, MKM_FALSE, 0								},
	{ "oracle_text", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_ORACLE_TEXT, MKM_FALSE, 0							},
	{ "reserved", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_RESERVED, MKM_FALSE, 0									},
	{ "foil", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_FOIL, MKM_FALSE, 0											},
	{ "nonfoil", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_NONFOIL, MKM_FALSE, 0									},
	{ "oversized", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_OVERSIZED, MKM_FALSE, 0								},
	{ "promo", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_PROMO, MKM_FALSE, 0										},
	{ "reprint", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_REPRINT, MKM_FALSE, 0									},
	{ "variation", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_VARIATION, MKM_FALSE, 0								},
	{ "set_name", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_SET_NAME, MKM_FALSE, 0									},
	{ "set_type", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_SET_TYPE, MKM_FALSE, 0									},
	{ "digital", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_DIGITAL, MKM_FALSE, 0									},
	{ "flavor_text", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_FLAVOR_TEXT, MKM_FALSE, 0							},
	{ "artist", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_ARTIST, MKM_FALSE, 0										},
	{ "back_id", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_BACK_ID, MKM_FALSE, 0									},
	{ "illustration_id", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_ILLUSTRATION_ID, MKM_FALSE, 0					},
	{ "border_color", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_BORDER_COLOR, MKM_FALSE, 0							},
	{ "frame", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_FRAME, MKM_FALSE, 0										},
	{ "full_art", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_FULL_ART, MKM_FALSE, 0									},
	{ "textless", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_TEXTLESS, MKM_FALSE, 0									},
	{ "booster", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_BOOSTER, MKM_FALSE, 0									},
	{ "power", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_POWER, MKM_FALSE, 0										},
	{ "toughness", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_TOUGHNESS, MKM_FALSE, 0								},
	{ "image_uri_small", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_IMAGE_URI_SMALL, MKM_FALSE, 0					},
	{ "image_uri_normal", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_IMAGE_URI_NORMAL, MKM_FALSE, 0					},
	{ "image_uri_large", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_IMAGE_URI_LARGE, MKM_FALSE, 0					},
	{ "image_uri_png", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_IMAGE_URI_PNG, MKM_FALSE, 0						},
	{ "image_uri_art_crop", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_IMAGE_URI_ART_CROP, MKM_FALSE, 0				},
	{ "image_uri_border_crop", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_IMAGE_URI_BORDER_CROP, MKM_FALSE, 0		},
	{ "recent_price_usd", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_PRICE, SFC_CARD_STRING_PRICE_USD, MKM_TRUE, 0							},
	{ "recent_price_usd_foil", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_PRICE, SFC_CARD_STRING_PRICE_USD_FOIL, MKM_TRUE, 0				},
	{ "recent_price_usd_etched", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_PRICE, SFC_CARD_STRING_PRICE_USD_ETCHED, MKM_TRUE, 0			},
	{ "recent_price_eur", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_PRICE, SFC_CARD_STRING_PRICE_EUR, MKM_TRUE, 0							},
	{ "recent_price_eur_foil", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_PRICE, SFC_CARD_STRING_PRICE_EUR_FOIL, MKM_TRUE, 0				},
	{ "recent_price_tix", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_PRICE_TIX, MKM_FALSE, 0						},
	{ "legality_standard", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_LEGALITY_STANDARD, MKM_FALSE, 0				},
	{ "legality_future", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_LEGALITY_FUTURE, MKM_FALSE, 0					},
	{ "legality_historic", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_LEGALITY_HISTORIC, MKM_FALSE, 0				},
	{ "legality_gladiator", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_LEGALITY_GLADIATOR, MKM_FALSE, 0				},
	{ "legality_pioneer", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_LEGALITY_PIONEER, MKM_FALSE, 0					},
	{ "legality_modern", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_LEGALITY_MODERN, MKM_FALSE, 0					},
	{ "legality_legacy", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_LEGALITY_LEGACY, MKM_FALSE, 0					},
	{ "legality_pauper", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_LEGALITY_PAUPER, MKM_FALSE, 0					},
	{ "legality_vintage", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_LEGALITY_VINTAGE, MKM_FALSE, 0					},
	{ "legality_penny", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_LEGALITY_PENNY, MKM_FALSE, 0						},
	{ "legality_commander", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_LEGALITY_COMMANDER, MKM_FALSE, 0				},
	{ "legality_brawl", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_LEGALITY_BRAWL, MKM_FALSE, 0						},
	{ "legality_historicbrawl", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_LEGALITY_HISTORICBRAWL, MKM_FALSE, 0		},
	{ "legality_alchemy", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_LEGALITY_ALCHEMY, MKM_FALSE, 0					},
	{ "legality_paupercommander", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_LEGALITY_PAUPERCOMMANDER, MKM_FALSE, 0	},
	{ "legality_duel", MKM_CONFIG_COLUMN_TYPE_SFC_STRING, MKM_CONFIG_COLUMN_DATA_TYPE_STRING, SFC_CARD_STRING_LEGALITY_DUEL, MKM_FALSE, 0						},
...
mkm_config_help()
{
	printf(
		...
		"        sql        Output is SQL code that can be used to update a Postgres\n"
		"                   SQL database.\n"
		"\n"
	...
	for(const mkm_config_option* option = option_list.head; option != NULL; option = option->next)
	{
		if(option->value[0] == '-')
		{
			...
			else if (strcmp(option->value, "--output") == 0)
			{
				...
				else if (strcmp(output_type, "sql") == 0)
				{
					config->output_callback = mkm_output_sql;

					/* SQL needs the 'unique_id' column */
					mkm_config_parse_columns(config, &last_column, "unique_id", MKM_FALSE);
				}
				else
			...
			else if (strcmp(option->value, "--sql_table") == 0)
			{
				option = option->next;
				MKM_ERROR_CHECK(option != NULL, "Expected SQL table name after --sql_table.");
				mkm_strcpy(config->sql_table, option->value, sizeof(config->sql_table));
			}
